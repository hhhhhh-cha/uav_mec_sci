...
def main():
    ...
    # For this verification run, use 200 episodes first.
    # After the ratio branch is confirmed to move upward, increase to 500 for final experiments.
    num_episodes = 200
    reward_scale = 1e-4
    policy_delay = 2
    grad_clip_norm = 1.0
    ...
    # Log / save dirs
    # -------------------------------------------------
    run_name = "proposed_full_stage2_seed72_safemobility_ratio_reg_coef10_res2"
    ...
    ckpt_prefix = "proposed_full_stage2_stable_k16_seed72_safemobility_cw100_ratio_reg10_res2"
