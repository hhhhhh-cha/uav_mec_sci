...
# Stage-2 收敛训练版 v7（refined-ratio distillation + one-step model refinement）：
...
def main():
    ...
    refined_ratio_bc_coef_start = _env_float("REFINED_RATIO_BC_COEF_START", 0.50)
    refined_ratio_bc_coef_end = _env_float("REFINED_RATIO_BC_COEF_END", 0.15)
    ...
    default_run_name = (
        f"proposed_full_stage2_v7_ratio_distill_k{K}_seed{base_seed}"
