...
RESULT_ROOT="results/convergence_training/v8_matched_stage1_stage2/no_pg"
...
do
  ...
  RUN_NAME="proposed_full_stage2_main_d25_seed${S}_ep700_v8_refine4_schedfix_no_pg_matched"
  CKPT_PREFIX="${RUN_NAME}"

  echo "============================================================"
  echo "Running STRICT MATCHED no_pg"
  echo "Seed          : ${S}"
  ...
  echo "[DONE] Seed ${S} no_pg finished."
  echo
done

echo "============================================================"
echo "All STRICT MATCHED no_pg seeds finished."
