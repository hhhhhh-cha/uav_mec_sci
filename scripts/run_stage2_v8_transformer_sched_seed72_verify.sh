...
RUN_NAME=proposed_full_stage2_main_d25_seed72_ep300_v8_transformer_sched_verify \
CKPT_PREFIX=proposed_full_stage2_main_d25_seed72_ep300_v8_transformer_sched_verify \
